 ...
 */
let zipReturn = zip( [Int](repeating: 0, count: 5) , 0 ..< 5 )
print(type(of: zipReturn))
/*
 // ** Your Problem 4.3 answer goes here **
 from line 151:  Zip2Sequence<Array<Int>, CountableRange<Int>>
 */
/*:
 4. In `positions`, what is the type of the value returned from the first call to map?
 */
let mapReturn = (0 ..< 5).map { zip( [Int](repeating: $0, count: 5) , 0 ..< 5 ) }
print(type(of: mapReturn))
/*
 // ** Your Problem 4.4 answer goes here **
 from line 160: Array<Zip2Sequence<Array<Int>, CountableRange<Int>>>
 */
/*:
 5. what is the type of the value returned from the call to flatMap?
 */
let flatMapReturn = (0 ..< 5)
    .map { zip( [Int](repeating: $0, count: 5) , 0 ..< 5 ) }
    .flatMap { $0 }
print(type(of: flatMapReturn))
/*
 // ** Your Problem 4.5 answer goes here **
 from line 171: Array<(Int, Int)>
 */
...
/*
 The relative positions of the neighbors of a given cell to be used in computing whether the cell lives in the next iteration.
 */
/*:
 ## Problem 6:
...
/*
 of is the external name of the variable used when calling the function
 */
/*:
...
/*
 cell is the internal name of the variable, used inside the function
 */
...
/*
 (Int, Position) -> Int (i.e. a function taking an Int and a Position returning an Int)
 */
/*:
 ## Problem 12:
...
/*
 because the subscript is specified as being able to return nil.
 */
/*:
...
/*
 if you pass in an invalid value for the position
 */
/*:
 ## Problem 16:
...
/*
 The number of living neighbors of the given cell
 */
...
/*
  $1 is the position of the current cell
 */
...
/*
  the next state of the grid according to the GoL rules
 */
/*:
 ## Problem 22:
